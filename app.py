...
# test_input = [age,gen_m,sq_index,bf_level,pps_score,stress_level,dep_phq9,fs_scale,pem_dur,
#               sleep_hrs,pem_y,med_y,ws_pw,ws_w,sl_l,sl_m,sl_vh,sl_vl,ex_n,ex_of,ex_r,ex_s,]
...
test_input = np.array([age,gen_m,sq_index,bf_level,pps_score,stress_level,dep_phq9,fs_scale,pem_dur,
              sleep_hrs,pem_y,med_y,ws_pw,ws_w,sl_l,sl_m,sl_vh,sl_vl,ex_n,ex_of,ex_r,ex_s,]).reshape(1, -1)
...
if st.button('Predict Diagnosis'):
    ...
    # prediction = selected_model.predict(test_input)[0]
